...
export class NodePlugin extends Plugin {
  ...
  init() {
    super.init();
    this.instancedMeshManager = this.pluginManager
  ...
  addNode(nodeInstance) {
    ...
    if (nodeInstance.cssObject && cssScene)
      cssScene.add(nodeInstance.cssObject);
    if (nodeInstance.labelObject && cssScene)
      cssScene.add(nodeInstance.labelObject);
