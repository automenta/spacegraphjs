...
import {
  LayoutWorkerManager,
  WorkerManager,
} from "../performance/WorkerManager.js";
...
export class PerformancePlugin extends Plugin {
  ...
  _checkPerformanceThresholds() {
    ...
    const performanceRatio =
      targetFrameTime / this.performanceMetrics.frameTime;
  ...
  updatePerformanceConfig(newConfig) {
    ...
    this.space.emit("performance:configChanged", {
      oldConfig,
  ...
  getWorkerStats() {
    const stats = {
      ...
      layoutWorkerManager: this.layoutWorkerManager
        ? this.layoutWorkerManager.getStats()
        : null,
    };
