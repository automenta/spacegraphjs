...
export class ConfirmDialog {
  ...
  _bindEvents() {
    $("#confirm-yes", this.confirmDialogElement)?.addEventListener(
      "click",
      this._onConfirmYes,
    );
    $("#confirm-no", this.confirmDialogElement)?.addEventListener(
      "click",
      this._onConfirmNo,
    );
  }
  ...
  dispose() {
    $("#confirm-yes", this.confirmDialogElement)?.removeEventListener(
      "click",
      this._onConfirmYes,
    );
    $("#confirm-no", this.confirmDialogElement)?.removeEventListener(
      "click",
      this._onConfirmNo,
    );
