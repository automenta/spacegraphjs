...
for (const path in demoModules) {
  ...
  if (module.demoMetadata && module.createGraph) {
    ...
    console.warn(
      `Demo module at ${path} is missing demoMetadata or createGraph export.`,
    );
  }
}
...
loadedPages.sort((a, b) => {
  ...
  // Ensure 'simplified-demo' comes second
  if (a.id === "simplified-demo") return -1;
  if (b.id === "simplified-demo") return 1;
