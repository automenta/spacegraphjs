...
function createGraph(space) {
  ...
  space.createNode({
    ...
    data: {
      ...
      height: 180,
      content:
        '<div style="padding:10px; background:#2a2a2b; border-radius:5px; color:white;">Chart Placeholder: Sales Q1</div>',
    },
    ...commonProps,
  });
  ...
  setTimeout(
    () =>
      space.plugins.getPlugin("LayoutPlugin")?.applyLayout("grid", {
        columns: 3,
        padding: { x: 200, y: 100 },
      }),
    100,
