...
function createGraph(space) {
  ...
  if (groupChild1 && groupChild2) {
    ...
    space.addEdge(groupChild1, groupChild2, {
      label: "Internal",
      color: 0xaaaaaa,
      thickness: 1,
    });
  ...
  if (noteNode && imageNode)
    space.addEdge(noteNode, imageNode, { label: "related" });
