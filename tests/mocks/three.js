...
export const Vector3 = vi.fn().mockImplementation((x = 0, y = 0, z = 0) => ({
  ...
  clone: vi.fn(function() { return new Vector3(this.x, this.y, this.z); }),
  ...
  normalize: vi.fn(function() { const l = this.length(); if (l > 0) this.multiplyScalar(1/l); return this; }),
  ...
  equals: vi.fn(function(v) { return ((v.x === this.x) && (v.y === this.y) && (v.z === this.z)); }),
  applyMatrix4: vi.fn(function() { return this; }), // Mock, does nothing
  project: vi.fn(function() { return this; }), // Mock, does nothing
}));
